...
// configuration step. It creates a namespace called `ManybodyBasisStateRepresentations`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ManybodyBasisStateRepresentations::cmake::project_name, ManybodyBasisStateRepresentations::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ManybodyBasisStateRepresentations::cmake::project_version);
      return EXIT_SUCCESS;
    }
